				...
				<div className="flex items-start justify-between gap-4">
					...
					<div className="flex items-center gap-2">
						<button
							...
							className="rounded-md border border-zinc-700 px-3 py-1.5 text-sm text-zinc-300 transition-colors hover:bg-zinc-800 min-h-11"
						>
							Edit
						</button>
						<button
							onClick={handleDelete}
							className="rounded-md border border-red-800/50 px-3 py-1.5 text-sm text-red-400 transition-colors hover:bg-red-900/30 min-h-11"
						>
							Delete
						</button>
						<button
							onClick={onClose}
							className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-100 min-h-11 min-w-11"
							aria-label="Close"
						>
							✕
						</button>
