...
export default function Home() {
	...
	const chips = useMemo(() => {
		...
		for (const cat of categories)
			result.push({ kind: "category", value: cat });
			...
			<div className="mx-auto w-full max-w-5xl">
				<div className="flex items-center justify-between pb-6">
					...
					<button
						...
						className="flex h-10 items-center gap-2 rounded-md bg-zinc-100 px-4 text-sm font-medium text-zinc-950 transition-colors hover:bg-zinc-200 min-h-11"
					>
						+ Create Note
					</button>
				</div>
