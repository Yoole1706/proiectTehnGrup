    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="flex w-full max-w-sm flex-col gap-6 rounded-xl border border-zinc-800 bg-zinc-900 p-8">
        ...
        <button
          ...
          disabled={submitting}
          className="flex h-11 items-center justify-center rounded-md bg-zinc-100 text-sm font-medium text-zinc-950 transition-colors hover:bg-zinc-200 disabled:cursor-not-allowed disabled:opacity-40 min-h-[44px]"
        >
          {submitting
            ? "Please wait…"
            : mode === "signin"
        ...
        <button
          ...
          disabled={submitting}
          className="flex h-11 items-center justify-center gap-2 rounded-md border border-zinc-700 text-sm font-medium text-zinc-300 transition-colors hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-40 min-h-[44px]"
        >
